...
class ProductDetailsActivity : AppCompatActivity() {
    ...
    private fun removeFromLikedProducts(productId: Int) {
        ...
        val request = Request.Builder()
            .url("http://192.168.80.63/backend/remove_from_liked_products.php")
            .post(requestBody)
            .build()
    ...
    private fun addToCart(productId: Int, quantity: Int) {
        ...
        val request = Request.Builder()
            .url("http://192.168.80.63/backend/add_to_cart.php")
            .post(requestBody)
            .build()
    ...
    private fun submitReview(productId: Int, rating: Int) {
        ...
        val request = Request.Builder()
            .url("http://192.168.80.63/backend/add_product_review.php")
            .post(requestBody)
            .build()
