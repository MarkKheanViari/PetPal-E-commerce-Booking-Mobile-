...
<<<<<<< Updated upstream
        val url = "http://192.168.43.55/backend/fetch_user_addresses.php?mobile_user_id=$mobileUserId"
=======
        val url = "http://192.168.38.63/backend/fetch_user_addresses.php?mobile_user_id=$mobileUserId"
>>>>>>> Stashed changes
