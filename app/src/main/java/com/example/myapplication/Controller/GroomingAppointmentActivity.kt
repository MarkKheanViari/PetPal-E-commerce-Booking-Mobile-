...
class GroomingAppointmentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this)
            .load("http://192.168.80.63/backend/$imageUrl")
    ...
    private fun submitAppointment() {
        ...
        if (paymentMethod.equals("GCASH", ignoreCase = true)) {
            ...
            val url = "http://192.168.80.63/backend/paymongo_appointment_checkout.php"
            ...
            val url = "http://192.168.80.63/backend/schedule_appointment.php"
            val request = JsonObjectRequest(
                Request.Method.POST, url, jsonObject,
                { response ->
