...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSaveProfile = findViewById(R.id.save_changesBtn)
        ...
        btnSaveProfile.setOnClickListener {
            ...
            updateUserProfile(username, email, address, phone)
        }
    }
    ...
    private fun updateUserProfile(
        ...
        val url = "https://192.168.137.14/backend/update_user_info.php"
