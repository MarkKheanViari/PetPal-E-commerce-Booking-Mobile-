...
class CartFragment : Fragment(), CartActionListener {
    ...
    override fun updateCartQuantity(cartId: Int, newQuantity: Int) {
        val url = "http://192.168.80.63/backend/update_cart.php"
    ...
    override fun removeItemFromCart(cartId: Int) {
        val url = "http://192.168.80.63/backend/remove_from_cart.php"
    ...
    private fun fetchCartItems() {
        ...
        val url = "http://192.168.80.63/backend/fetch_cart.php?mobile_user_id=$mobileUserId"
